...
return [
    ...
    */
    ...
    'from' => [
        'address' => env('EMAIL_FROM_ADDRESS', env('MAIL_FROM_ADDRESS', 'noreply@tokodigitalraja.com')),
        'name' => env('EMAIL_FROM_NAME', env('MAIL_FROM_NAME', env('APP_NAME', 'Toko Digital Raja'))),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for external email API service
