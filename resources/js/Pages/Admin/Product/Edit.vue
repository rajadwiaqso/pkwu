                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-4">
                            <div v-if="mainImagePreview || product.main_image_url" class="w-32 h-32 rounded-lg overflow-hidden">
                                <img :src="mainImagePreview || product.main_image_url" class="w-full h-full object-cover">
                            </div>
                            <label class="flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed rounded-lg cursor-pointer hover:border-emerald-500">
                                ...
                                <span class="text-xs text-gray-500 mt-1">Ganti</span>
                    ...
                    <div v-if="product.images?.length > 0" class="mb-4">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <div v-for="image in product.images" :key="image.id" class="relative w-24 h-24">
                                <img :src="image.image_url" class="w-full h-full object-cover rounded-lg">
                    ...
                    <!-- Additional Images -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Upload Gambar Baru (akan mengganti yang lama)</label>
                        <div class="flex flex-wrap gap-4">
...
const form = useForm({
    ...
    verified_price: props.product.verified_price,
...
const deleteImage = (imageId) => {
    if (confirm('Hapus gambar ini?')) {
        router.delete(route('admin.products.images.delete', imageId));
    }
};
